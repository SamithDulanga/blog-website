    ...
    return (
        <div className="px-4 py-10  w-full">
            <div>
                ...
                <div className="text-gray-100 lg:w-3/5  mx-auto text-xl mt-3 font-primary border rounded-2xl p-10 bg-emerald-700 flex flex-col ">
                   <div> 🚀 <span className="font-bold text-amber-500">ThingsToKnow</span> is your passport to a world of curated insights,
                    ...
                    <div className="my-5 flex flex-col justify-center items-center border-2 p-5 gap-2 " >
                        ...
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <Link to="https://www.youtube.com/@thingstoknow5847" className="text-sm hover:scale-110 duration-300 px-5 flex items-center" target="_blank">https://www.youtube.com/@thingstoknow5847</Link>
