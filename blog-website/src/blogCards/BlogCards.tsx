        ...
        <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-8 mx-3" >
            {
                filteredBlogs.map((blog)=>
                    <div key={blog.id} className="shadow-lg rounded-lg px-5 py-5">
                        ...
                        {/*<NavLink*/}
                        {/*    to="content"*/}
                        {/*    className="flex items-center gap-3 hover:text-red-500 cursor-pointer text-gray-500"*/}
                        {/*>*/}
                        ...
                        <Link
                            to={`blog/${blog.id}`}
                            className="flex items-center gap-3 hover:text-red-500 cursor-pointer text-gray-500 duration-500"
                        >
                            Read More <FaArrowRightLong />
                        </Link>
